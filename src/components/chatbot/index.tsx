...
const Chatbot: React.FC = () => {
    ...
    }, [addMessage, isProcessing, queryChat, scrollToBottom, updateMessage]);
                                    ...
                                    <>
                                        {msg.text ? (
                                            <TypewriterText
                                                ...
                                                messageId={msg.id}
                                                isBot={true}
                                                startAnimation={isCurrentlyAnimating}
                                                onComplete={isCurrentlyAnimating ? handleAnimationComplete : undefined}
                                                onProgress={isCurrentlyAnimating ? handleAnimationProgress : undefined}
                                                speed={20}
                                            />
                                        ) : (
    ...
    }, [isOpen, currentSession, scrollToBottom]);
