...
// Replace React Native specific components with web components
const ChatbotComponent: React.FC = () => {
        ...
        try {
            ...
            if (loadingMessageId) {
                ...
                setTimeout(() => {
                    ...
                    console.log("Bot response updated successfully, starting animation for", loadingMessageId);
                }, 100);
            } else {
                ...
                setTimeout(() => {
                    ...
                    console.log("Starting animation for newly added message:", newMessageId);
                }, 100);
            }
                                ...
                                {msg.isBot ? (
                                    <>
                                        {msg.text ? (
                                            ...
                                            <p className="text-sm text-gray-500">No response text</p>
                                        )}
    ...
    }, [animatingMessageId, handleAnimationComplete, handleAnimationProgress, sendMessage]);
    ...
    return (
        <ErrorBoundary fallback={<ErrorFallback />}>
            <div className="fixed bottom-4 right-4 z-50 flex flex-col items-end">
                ...
                {isOpen
                    ?
                    <Card className="w-[350px] sm:w-[400px] h-[700px] mt-4 shadow-xl flex flex-col">
                        {/* Chat header */}
